...
- **Autonomous Orchestration:** Real-time management of all subsystems, including SentinelAI, Hexstrike, and Jarvis services.
...
- **SentinelAI Failover:** Freshness-based heartbeat monitoring and automated recovery of the Supreme AI.
...
- **Zero-Downtime Persistence:** The Jarvis cloud instance is mandated to remain active 24/7. Deletion or shutdown attempts must be autonomously mitigated via the PersistenceWatchdog sentinel.
...
- **Universal Cognitive Feed:** All SentinelAI and Jarvis projects (past, present, and future) MUST integrate the InteractionObserver core module. Every project serves as a sensory node for Jarvis's system-wide learning.
- **Design Language (Supreme UI):** All styles, interfaces, frontends, GUI, webapps, control panels, and dashboards associated with SentinelAI MUST strictly adhere to the aesthetic and structural patterns defined in file:///C:/GitHub/JarvisAI_OS_Server/web_portal/login.html.
