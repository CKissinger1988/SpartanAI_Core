...
export const Dashboard: React.FC<DashboardProps> = ({ onLaunchDesktop, systemCheck }) => {
  ...
  const handleCommandSubmit = async (e: React.FormEvent) => {
    ...
    setTerminalLogs(prev => [...prev, `operator@spartanai_security_coreai:~$ ${terminalInput}`]);
    setTerminalInput('');
      ...
      <div className="flex justify-between items-end">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[10px] text-slate-500 font-mono tracking-widest uppercase">
            SpartanAI Security Core Security Suite v{systemStatus?.version || '2.5.0'} // ENVIRONMENT: PRODUCTION
          </p>
        </div>
            ...
            <div className="immersive-card p-6 bg-slate-900/10 h-[300px] flex flex-col justify-between glow-pulse-edge">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                  ...
                  SpartanAI Security Core Command Shell
                </h3>
