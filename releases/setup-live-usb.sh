...
# 4. Install supporting security binaries (Nmap, Metasploit, etc.)
echo -e "${YELLOW}[*] Updating system dependencies...${NC}"
apt-get update -y || true
apt-get install -y nmap daemonize iptables curl || true

# 5. Create autostart Systemd service
...
# 7. Configure iptables to redirect standard HTTP traffic (optional, port 80 to 3000)
